...
class RightBoxMobile extends StatelessWidget {
  const RightBoxMobile({super.key});
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Text(
                      'Number of images: ',
                      style: GoogleFonts.roboto(
                        fontSize: controller.isMobile ? 12 : 14, // Use controller.isMobile here
                        color: Colors.black,
                      ),
                    ),
                    Text(
                ...
                Text(
                  'Details:',
                  style: GoogleFonts.roboto(
                    fontSize: controller.isMobile ? 14 : 16, // Use controller.isMobile here
                    fontWeight: FontWeight.bold,
                    color: Colors.black,
                  ),
                ),
